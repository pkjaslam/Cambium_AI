...
def collect_metrics(live=True):
    ...
    pol = open(os.path.join(ROOT, "AI_POLICY.md"), encoding="utf-8").read()
    m["policy_enforced"] = str(len(re.findall(r"^## \d+\. .* — \*\*enforced", pol, re.M)))
    pos = open(os.path.join(ROOT, "POSITIONING.md"), encoding="utf-8").read()
...
<body><div class="wrap">
 ...
 <a href="../evals/enforcement_study/RESULTS.md">RESULTS.md</a> · <a href="../POSITIONING.md">POSITIONING.md</a> · <a href="../AI_POLICY.md">AI_POLICY.md</a></footer>
</div></body></html>"""
